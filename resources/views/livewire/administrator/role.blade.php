<div>
    <div class="w-96  rounded-lg mx-auto" id="ck">
        <div>
        <form wire:submit.prevent="roleinput">
            <div>
           ...
           <label for="role">Masukkan Jenis Role</label>
            ...
            <table class="table table-report sm:mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap">jenis Admin</th>
                ...
                <tbody>
                    ...
                    <td class="w-40">
                        ...
                        <div class="flex">
                            <div class="w-10 h-10 image-fit zoom-in">
                            <a class="px-5 py-2 text-yellow-500 " href="{{url('role/edit')}}/{{$rol->id}}"><i class="bi bi-pencil-square"></i> </a> 
@endrole
                        </div>
                        <div class="w-10 h-10 image-fit zoom-in">
                            <a class="px-5 py-2 text-red-500"><i class="bi bi-trash" wire:click='deleterol({{$rol->id}})'></i> </a> 
